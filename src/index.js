  ...
  res.send(`
    ...
    <body>
      <div class="header">
        ...
        <p>Backstage-compatible developer experience platform</p>
      </div>
      
      <div class="card">
        <h2>Welcome to DevOpsCanvas</h2>
        <p>This is a Backstage-compatible developer portal for managing your services and infrastructure.</p>
